...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./RAMIS.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("RA", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S RAMIS -X kill
screen -S RAMIS ./RAMIS
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/blackkoi/flll-ramis/master/File_Bot/commands.lua") 
...
if tonumber(user_id) == tonumber(698440689) then  
var = true  
...
local RAMIS_Msg = ''  
if msgs < 100 then 
RAMIS_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
RAMIS_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
RAMIS_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
RAMIS_Msg = 'متفاعل' 
elseif msgs < 1200 then 
RAMIS_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
RAMIS_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
RAMIS_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
RAMIS_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
RAMIS_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
RAMIS_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
RAMIS_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
RAMIS_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
RAMIS_Msg = 'رب التفاعل'  
end 
return RAMIS_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceRAMIS(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,RAMIS_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf RAMIS.lua')
os.execute('wget https://raw.githubusercontent.com/blackkoi/RAMIS1/master/RAMIS.lua')
send(msg.chat_id_, msg.id_,' ★∫ تم تحديث السورس \n ★∫ لديك اخر اصدار لسورس راميس\n ★∫ الاصدار » { 1.3v}')
dofile('RAMIS.lua')  
end
if text == 'الاصدار ★' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ★∫ اصدار سورس راميس \n ★∫ الاصدار »{ 1.3v}')
end
...
send(msg.chat_id_, msg.id_,'★∫  عدد الكروبات الان » { '..#group..' }'..RAMISk..''..RAMIS..'\n★∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
local RAMIS1_Msg = database:get(bot_id.."RAMIS1:Add:Filter:Rp2"..text..msg.chat_id_)   
if RAMIS1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ★∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ZNZNN')..') \n ★∫ '..RAMIS1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if RAMIS_Msg and not Special(msg) then  
local RAMIS_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if RAMIS_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
🌐┇[RAMiS TEAM](T.ME/ZNZNN)
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📊┇ [Source Channel](T.ME/ZNZNN)

📋┇ [🌿RaMiS Dev](T.ME/RRTTT)

📁┇ [Source  Files](T.Me/ZNZNN)

 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
📧┇ [TWS RaMiS](t.me/RRTTT)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ★∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ZNZNN')..') \n ★∫ تـم قفـل الدردشه ')
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/blackkoi/flll-ramis/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ★∫ اهلا بك في متجر ملفات راميس\n ★∫ ملفات السورس ↓\n≪━━━━━━━━━━━━━≫\n\n"
...
local json_file, res = https.request("https://raw.githubusercontent.com/blackkoi/flll-ramis/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('RAMIS.lua')  
else
send(msg.chat_id_, msg.id_," ★∫ عذرا الملف لايدعم سورس راميس \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ZNZNN')..')'
...
database:set(bot_id.."RAMIS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."RAMIS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ★∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."RAMIS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."RAMIS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."RAMIS1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."RAMIS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ★∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."RAMIS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."RAMIS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."RAMIS1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."RAMIS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ★∫ ارسل الكلمه الان")  
database:set(bot_id.."RAMIS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."RAMIS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."RAMIS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."RAMIS1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."RAMIS1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."RAMIS1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."RAMIS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."RAMIS1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."RAMIS1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ★∫ قائمة المنع \n≪━━━━━━━━━━━━━≫\n"
for k,v in pairs(list) do  
local RAMIS_Msg = database:get(bot_id.."RAMIS1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..RAMIS_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'راميس').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'راميس')
local RAMIS_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..RAMIS_Msg[math.random(#RAMIS_Msg)]..']') 
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'راميس').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'ZNZNN')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
RAMISdx(msg.chat_id_, msg.id_, ' ★∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ★∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ★∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ★∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'راميس')
...
RAMIS = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(RAMIS)
...
--------------------------------------------------------------------------------------------------------------
SourceRAMIS(data.message_,data)
...
------------------------------------------------------------------------
local RAMISAbot = database:get(bot_id.."RAMIS1:Add:Filter:Rp2"..text..result.chat_id_)   
if RAMISAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ★∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ★∫ ["..RAMISAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local RAMIS1_Msg = database:get(bot_id.."RAMIS1:Add:Filter:Rp2"..text..result.chat_id_)   
if RAMIS1_Msg then    
send(msg.chat_id_, msg.id_," ★∫ "..RAMIS1_Msg)
